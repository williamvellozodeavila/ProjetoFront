     ...
     <main>
        ...
        <section className="mt-5 mb-5 max-w-screen-xl mx-auto">
          <div className="flex flex-row justify-between">
            <h1 className="mt-5 mb-5 text-3xl font-extrabold leading-none tracking-tight text-blue-500 md:text-3xl lg:text-4xl dark:text-white">Agenda do dia </h1>
            <a href="/novoAgendamento" className="w-44 text-white bg-blue-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center m-5">
                  + Agendamento
            </a>
