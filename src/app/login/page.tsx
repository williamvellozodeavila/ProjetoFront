...
//      alert("Olá " + dados.nome)
  ...
  return (
    ...
    <div className="w-screen h-screen bg-gradient-to-r from-blue-400 to-white flex items-center justify-center">
      ...
      <div className="flex-col items-center w-1/3 ml-10">
        <div className="w-full bg-gray-100 rounded-lg shadow dark:border md:mt-20 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form className="space-y-4 md:space-y-6" 
              ...
              <div className="flex flex-row">             
                <button type="submit" className="w-full text-white bg-blue-400 hover:bg-primary-700 focus:ring-4 focus:outline-none m-1 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  Entrar
                </button>
                <a href="/alterar-senha" className="w-full text-white bg-black hover:bg-primary-700 focus:ring-4 focus:outline-none m-1 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  Esqueci a senha
                </a>
              </div>
            </form>
