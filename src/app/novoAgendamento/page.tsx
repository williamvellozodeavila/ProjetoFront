...
export default function Cadastro() {
  ...
  async function verificaCadastro(data: Inputs) {
    ...
    if (response.status === 201) {
      ...
      // Redireciona para a página de Agenda após o novo agendamento
